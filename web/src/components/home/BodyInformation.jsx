    ...
    >
      ...
      <Row style={{ padding: "20px 0" }}>
        <Col span={10} style={{ height: "100%" }}>
          ...
          >
            ...
            <Row style={{ justifyContent: "flex-start" }}>
              <span style={{ fontSize: "10px", padding: "6px 0" }}>
                Chiều cao 170cm
              </span>
            </Row>
          </div>
        ...
        >
          ...
          >
            <Row style={{ fontSize: "12px", color: "white" }}>
              Chỉ số cơ thể (BMI)
            </Row>
            <Row
              style={{
            ...
            <Row style={{ width: "100%" }}>
              ...
              >
                {BMIHardCode.map((bmi, index) => (
                  <span key={index} style={{ fontSize: "8px", color: "white" }}>
                    {bmi}
                  </span>
                ))}
              </Row>
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            >
              <span style={{ color: colors.grayDark, fontSize: "10px" }}>
                Ngực
              </span>
